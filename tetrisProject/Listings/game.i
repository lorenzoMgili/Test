...
void update(){
 ...
 if (numTicsFromLastUpdate >= 10/flags.speed){
...
void drawScore() {
 ...
 GUI_Text(start.x, start.y,(uint8_t *) highScore, 0xFFFF, 0x0000);
 GUI_Text(start.x, start.y + 20,(uint8_t *) currentScore, 0xFFFF, 0x0000);
 GUI_Text(start.x, start.y + 40,(uint8_t *) deletedLines, 0xFFFF, 0x0000);
}
...
void initGame(){
 ...
 drawRect((Position){0,0}, (Position){cellSize*col + 2 * marginSize, marginSize}, 0xFFFF); //top
 drawRect((Position){0,cellSize*row + marginSize}, (Position){cellSize*col + 2 * marginSize, cellSize*row + 2 * marginSize}, 0xFFFF); //bottom
 drawRect((Position){0,0}, (Position){marginSize, cellSize*row + 2 * marginSize}, 0xFFFF); //left
 drawRect((Position){cellSize*col + marginSize,0}, (Position){cellSize*col + 2 * marginSize, cellSize*row + 2 * marginSize}, 0xFFFF); //right
