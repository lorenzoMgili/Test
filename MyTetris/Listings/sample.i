...
int main(void) {
 ...
 ADC_init();
   ...
   ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR |= (1<<27);
   ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET = (1<<27);
 ...
 ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= 0x2;
